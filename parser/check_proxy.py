#!/usr/bin/env python3
"""
Скрипт для проверки настроек прокси в контейнере parser.
"""
import os
...
def check_proxy():
    ...
    print("=" * 60)
    print("Проверка настроек прокси в контейнере parser")
    print("=" * 60)
    ...
    print("=" * 60)
    print("\nДля настройки прокси добавьте в .env файл:")
    print("  Вариант 1: PROXY=http://user:pass@host:port")
    print("  Вариант 2:")
    print("    PROXY_HOST=host")
    print("    PROXY_PORT=port")
    print("    PROXY_USERNAME=user (опционально)")
    print("    PROXY_PASSWORD=pass (опционально)")
    print("=" * 60)
    return False
